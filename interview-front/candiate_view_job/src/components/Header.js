...
const Header = () => {
    return (
        <div className="rounded-md">
            <div className="bg-white relative flex items-center n justify-center overflow-hidden z-0 ">
                        ...
                        <div className=" relative ">
                            <div className="lg:max-w-xl lg:pr-5 relative z-40">
                                ...
                                <h2 className="mb-6 max-w-lg text-5xl font-light leading-snug tracking-tight text-g1 sm:text-7xl sm:leading-snug">
                                    ...
                                    <span className="ml-10">to shine</span>
                                </h2>
                                <p className="text-base text-gray-700">
                                    Join the team that mobilises millions of
                                    Vietnam everyday
                                </p>
